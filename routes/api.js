	...
	app
		...
		.put((req, res) => {
			...
			if (JSON.stringify(req.body) == '{}') {
				...
				updateForm['issue_title'] =
					req.body.issue_title != '' ? req.body.issue_title : null;
				updateForm['issue_text'] =
					req.body.issue_text != '' ? req.body.issue_text : null;
				updateForm['created_by'] =
					req.body.created_by != '' ? req.body.created_by : null;
				updateForm['assigned_to'] =
					req.body.assigned_to != '' ? req.body.assigned_to : null;
				updateForm['status_text'] =
					req.body.status_text != '' ? req.body.status_text : null;
